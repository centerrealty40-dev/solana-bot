...
| W8.0-p5 | [`W8.0_phase5_risk_capital_gates_spec.md`](./W8.0_phase5_risk_capital_gates_spec.md) | **normative draft** (Phase 5: §3.3–§3.4 перед adapter; `simulate` + RPC `free_usd`; см. [`W8.0_IMPLEMENTATION_PHASES`](./W8.0_IMPLEMENTATION_PHASES.md)) | W8.0-p4 + [`W8.0_live_oscar_trading_bot.md`](./W8.0_live_oscar_trading_bot.md) §3.3–§3.4 |
