...
| W8.0-p4 | [`W8.0_phase4_oscar_parity_adapter_spec.md`](./W8.0_phase4_oscar_parity_adapter_spec.md) | **normative draft** (Phase 4: паритет Oscar → execution adapter; без риска §3.3–§3.4 и без `send`; см. [`W8.0_IMPLEMENTATION_PHASES`](./W8.0_IMPLEMENTATION_PHASES.md)) | W8.0-p3 + paper Oscar (`main`/`tracker`) |
