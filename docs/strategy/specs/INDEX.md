...
| W8.0 | [`W8.0_live_oscar_trading_bot.md`](./W8.0_live_oscar_trading_bot.md) | **normative draft** (live Oscar параллельно paper: ENV лимиты, Jupiter swap + QN RPC, свежесть цены vs PG, dry-run/simulate/live, JSONL) | W6.3c + W7.4 + release model |
| W8.0-p1 | [`W8.0_phase1_live_jsonl_contract.md`](./W8.0_phase1_live_jsonl_contract.md) | **normative draft** (контракт JSONL live-oscar: `liveSchema: 1`, `intentId`, `execution_*` / `risk_block` / `capital_*`, матрица fsync; дорожная карта: [`W8.0_IMPLEMENTATION_PHASES.md`](./W8.0_IMPLEMENTATION_PHASES.md)) | W8.0 Phase 0 |
