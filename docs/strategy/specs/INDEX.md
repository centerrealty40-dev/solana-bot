...
| W8.0 | [`W8.0_live_oscar_trading_bot.md`](./W8.0_live_oscar_trading_bot.md) | **normative draft** (live Oscar параллельно paper; **Phase 2 в коде:** Jupiter quote/swap `src/live/jupiter.ts`, продукт **1.5.0**; см. [`W8.0_IMPLEMENTATION_PHASES`](./W8.0_IMPLEMENTATION_PHASES.md)) | W6.3c + W7.4 + release model |
