...
function makeMirrorApp({ name, walletSecret, walletPubkey, dataDir, leaders }) {
  return {
    ...
    env: {
      ...
      MILD_DIP_MIRROR_REQUIRE_DIP_CANDLE: name === 'mild-dip-mirror' ? '0' : '1',
      ...
      MILD_DIP_MIRROR_LEADER_FILL_GRACE_MS: name === 'mild-dip-mirror' ? '60000' : '0',
      MILD_DIP_MIRROR_MIN_LEADER_SIZE_USD: name === 'mild-dip-mirror' ? '20' : '0',
      MILD_DIP_MIRROR_QUOTE_INTERVAL_MS: '3000',
      MILD_DIP_MIRROR_QUOTE_MAX_AGE_MS: '10000',
      MILD_DIP_MIRROR_MIN_LIQUIDITY_USD: '8000',
      ...
      MILD_DIP_MIRROR_STRUCTURAL_MAX_MINTS: '4',
      MILD_DIP_MIRROR_STRUCTURAL_GAP_MS: '5000',
      MILD_DIP_MIRROR_POSITION_USD: name === 'mild-dip-mirror' ? '10' : '30',
      MILD_DIP_MIRROR_MAX_PC5M_PCT: '0',
      MILD_DIP_MIRROR_MAX_VOL5M_TO_LIQ: '2',
      MILD_DIP_MIRROR_REQUIRE_DEEP_DUMP: '0',
      MILD_DIP_MIRROR_DEEP_DUMP_PCT: '-8',
      ...
      MILD_DIP_MIRROR_LADDER_STEP_PCT: '5',
      MILD_DIP_MIRROR_LADDER_STEP_AFTER_AVG_PCT: '10',
      ...
      MILD_DIP_MIRROR_AVERAGE_MIN_DISCOUNT_PCT: name === 'mild-dip-mirror' ? '2' : '0',
