...
const PM2_APPS = [
    ...
    },
    {
      ...
      env: {
        NODE_ENV: 'production',
        RAYDIUM_COLLECTOR_INTERVAL_MS: '45000',
    ...
    },
    {
      ...
      env: {
        NODE_ENV: 'production',
        METEORA_COLLECTOR_INTERVAL_MS: '50000',
    ...
    // sa-orca disabled 2026-05-26: orca-collector runaway CPU since 2025-05-24; negligible for live-oscar (pumpswap lane).
    {
      ...
      env: {
        NODE_ENV: 'production',
        MOONSHOT_COLLECTOR_INTERVAL_MS: '55000',
    ...
    },
    {
      ...
      env: {
        ...
        PAPER_RUNNER_PROBE_MAX_CONCURRENT: '2',
        PAPER_RUNNER_PROBE_MAX_EXPOSURE_USD: '2000',
