/** VPS `/opt/solana-alpha`: Live Oscar + DEX snapshot collectors + collector-watch (PM2). Без бумажных Oscar / дашборда / Jupiter-watcher / wallet-orch / direct-lp — меньше фоновой нагрузки и конкуренции за Jupiter API. */
...
module.exports = {
  apps: [
    ...
    },
    {
      name: 'live-oscar',
      cwd: root,
      /** Прямой `tsx` — один node-процесс под PM2, без гонок `npm run` при reload. */
