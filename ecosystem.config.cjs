...
function makeMirrorApp({
  ...
  return {
    ...
    env: {
      ...
      MILD_DIP_MIRROR_CROSS_LEADER_AVERAGE_MIN_DISCOUNT_PCT: '10',
      MILD_DIP_MIRROR_CROSS_LEADER_AVERAGE_MAX_AGE_MS: '300000',
      MILD_DIP_MIRROR_CROSS_LEADER_AVERAGE_MAX_TIMES: '1',
      ...
      MILD_DIP_MIRROR_AVERAGE_MIN_DISCOUNT_PCT: '30',
