...
const PM2_APPS = [
    ...
    },
    {
      ...
      env: {
        ...
        PAPER_PRIORITY_DISCOVERY_REEVAL_SEC: '10',
        ...
        /** 1.11.274 — sub-minute Jupiter spot cache from priority-jupiter-spot-watch. */
        PAPER_PRIORITY_JUPITER_SPOT_CACHE: '1',
        ...
        MARKET_FAST_ALERT_DEDUPE_PATH: path.join(root, 'data/live/market-fast-alert-dedupe.json'),
     ...
     */
    {
      ...
      env: {
        NODE_ENV: 'production',
        SPIKE_ALERT_POLL_INTERVAL_MS: '10000',
    ...
    },
    {
      ...
      env: {
        ...
        PULLBACK_ALERT_POLL_INTERVAL_MS: '10000',
    ...
    },
    {
      ...
      env: {
        ...
        RETRACE_ALERT_POLL_INTERVAL_MS: '10000',
    ...
    {
      name: 'market-priority-jupiter-spot-watch',
      cwd: root,
      script: 'npm',
      args: 'run --silent market-priority-jupiter-spot-watch',
      interpreter: 'none',
      exec_mode: 'fork',
      instances: 1,
      autorestart: true,
      ...
      env: {
        NODE_ENV: 'production',
        PRIORITY_JUPITER_SPOT_POLL_MS: '10000',
        PRIORITY_JUPITER_SPOT_MAX_MINTS: '150',
        PRIORITY_JUPITER_SPOT_MIN_MCAP_USD: '2000000',
        PRIORITY_JUPITER_SPOT_QUOTE_ENABLED: '1',
        PRIORITY_JUPITER_SPOT_QUOTE_MAX_PER_TICK: '25',
        PRIORITY_JUPITER_SPOT_QUOTE_PROBE_USD: '25',
        PRIORITY_JUPITER_SPOT_NEAR_MISS_MAX: '25',
        PRIORITY_JUPITER_SPOT_NEAR_MISS_GAP_PCT: '3',
        PRIORITY_JUPITER_SPOT_NEAR_MISS_ROLLING: '1',
        PRIORITY_JUPITER_SPOT_DEXSCREENER_FALLBACK: '1',
        PRIORITY_JUPITER_SPOT_DEXSCREENER_MAX_PER_TICK: '12',
        PRIORITY_MINT_SPOT_PG_ENABLED: '1',
        ...
        PRIORITY_JUPITER_SPOT_MINTS_PATH: path.join(root, 'data/live/priority-jupiter-spot-mints.json'),
        MARKET_FAST_ALERT_DEDUPE_PATH: path.join(root, 'data/live/market-fast-alert-dedupe.json'),
        MARKET_FAST_ALERT_DEDUPE_MS: '300000',
        LIVE_MINT_WHITELIST_PATH: path.join(root, 'data/live/live-oscar-mint-whitelist.txt'),
        SPIKE_ALERT_TELEGRAM_CHAT_ID: SPIKE_TELEGRAM_CHAT_ID,
        PULLBACK_ALERT_TELEGRAM_CHAT_ID: DIPS_TELEGRAM_CHAT_ID,
        RETRACE_ALERT_TELEGRAM_CHAT_ID: DIPS_TELEGRAM_CHAT_ID,
