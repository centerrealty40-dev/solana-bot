...
function makeMirrorApp({ name, walletSecret, walletPubkey, dataDir, leaders }) {
  return {
    ...
    env: {
      ...
      MILD_DIP_MIRROR_GREEN_COPY_ENABLED: name === 'mild-dip-mirror' ? '0' : '1',
      ...
      MILD_DIP_MIRROR_LEADER_MAX_AGE_MS: '45000',
      MILD_DIP_MIRROR_OBSERVE_MS: name === 'mild-dip-mirror' ? '86400000' : '45000',
      MILD_DIP_MIRROR_QUOTE_INTERVAL_MS: '3000',
      MILD_DIP_MIRROR_QUOTE_MAX_AGE_MS: '10000',
      MILD_DIP_MIRROR_MIN_LIQUIDITY_USD: '8000',
      MILD_DIP_MIRROR_MIN_PAIR_AGE_HOURS: name === 'mild-dip-mirror' ? '6' : '0.5',
      MILD_DIP_MIRROR_MIN_MCAP_USD: name === 'mild-dip-mirror' ? '150000' : '5000',
      MILD_DIP_MIRROR_MAX_OPEN: '8',
      MILD_DIP_MIRROR_MAX_QUOTE_MINTS: '8',
      MILD_DIP_MIRROR_TICK_INTERVAL_MS: '2000',
      MILD_DIP_MIRROR_STRUCTURAL_MAX_MINTS: '4',
      MILD_DIP_MIRROR_STRUCTURAL_GAP_MS: '5000',
      MILD_DIP_MIRROR_POSITION_USD: name === 'mild-dip-mirror' ? '5' : '30',
      MILD_DIP_MIRROR_MAX_PC5M_PCT: '0',
      MILD_DIP_MIRROR_MAX_VOL5M_TO_LIQ: '2',
      MILD_DIP_MIRROR_REQUIRE_DEEP_DUMP: '0',
      MILD_DIP_MIRROR_DEEP_DUMP_PCT: '-8',
      MILD_DIP_MIRROR_GREEN_IMPULSE_PCT: '5',
      MILD_DIP_MIRROR_RUNUP_PC5M_PCT: '10',
      MILD_DIP_MIRROR_MAX_PREMIUM_PCT: name === 'mild-dip-mirror' ? '-1' : '2',
      MILD_DIP_MIRROR_RETRY_WHILE_LEADER_HOLDS: name === 'mild-dip-mirror' ? '1' : '0',
      MILD_DIP_MIRROR_LADDER_STEP_PCT: name === 'mild-dip-mirror' ? '5' : '5',
      MILD_DIP_MIRROR_LADDER_STEP_AFTER_AVG_PCT: name === 'mild-dip-mirror' ? '10' : '10',
      MILD_DIP_MIRROR_LADDER_SELL_FRACTION: name === 'mild-dip-mirror' ? '0.2' : '0.2',
      MILD_DIP_MIRROR_LADDER_DUST_USD: name === 'mild-dip-mirror' ? '1.5' : '1.5',
      MILD_DIP_MIRROR_AVERAGE_ENABLED: name === 'mild-dip-mirror' ? '1' : '0',
      MILD_DIP_MIRROR_AVERAGE_USD: '2.5',
      MILD_DIP_MIRROR_AVERAGE_WINDOW_MS: '10800000',
      MILD_DIP_MIRROR_AVERAGE_EXCLUDE_TAIL_MS: '900000',
      MILD_DIP_MIRROR_AVERAGE_TOLERANCE_PCT: '0.5',
      MILD_DIP_MIRROR_AVERAGE_MAX_TIMES: '1',
      MILD_DIP_MIRROR_COOLDOWN_MS: '900000',
      MILD_DIP_MIRROR_EXIT_ARM_PCT: '2',
      MILD_DIP_MIRROR_EXIT_TRAIL_PCT: name === 'mild-dip-mirror' ? '0' : '4',
      MILD_DIP_MIRROR_EXIT_STOP_PCT: '45',
      MILD_DIP_MIRROR_NO_MOVE_CUT_MS: '600000',
      MILD_DIP_MIRROR_NO_MOVE_MIN_MFE_PCT: '2',
      MILD_DIP_MIRROR_MAX_HOLD_MS: '3600000',
...
if (mildDipBotApp) {
  PM2_APPS.push(
    makeMirrorApp({
      ...
      leaders: '8zkgFGVZrDLieViwqiXFCydSX6WL5hsxmUu55yBdsNsZ,7BNaxx6KdUYrjACNQZ9He26NBFoFxujQMAfNLnArLGH5',
    }),
    makeMirrorApp({
