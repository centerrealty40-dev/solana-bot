...
if (mildDipBotApp) {
  ...
  PM2_APPS.push({
    ...
    env: {
      ...
      // закон ликвидности: $30k→$10, $100k→~$28.5, ≈$190k+→$50.
      // откат: MILD_DIP_SIZE_LIQ_POWER_COEF='0', MILD_DIP_SIZE_MAX_USD='10',
      // MILD_DIP_GREEN/FIRST_TOUCH='10', MILD_DIP_MIRROR_LOSS_CAP_USD='50'.
      MILD_DIP_GREEN_POSITION_USD: '50',
      MILD_DIP_POSITION_USD: '10',
      MILD_DIP_SIZE_MIN_USD: '10',
      MILD_DIP_SIZE_LIQ_POWER_COEF: '0.001333',
      MILD_DIP_SIZE_LIQ_POWER_EXP: '0.866',
      MILD_DIP_SIZE_MAX_USD: '50',
      MILD_DIP_FIRST_TOUCH_POSITION_USD: '50',
