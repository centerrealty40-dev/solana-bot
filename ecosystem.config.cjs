...
module.exports = {
  apps: [
    ...
    /**
     * Paper Oscar **TP-regime**: та же воронка входа, что **`pt1-oscar`** ($100k–$200k liq, holders ≥1k),
     * но включена классификация пути до входа (**down / sideways / up / unknown**) → overrides сетки TP / kill.
     */
    {
      name: 'pt1-oscar-regime',
      cwd: root,
      script: 'npm',
      args: 'run --silent papertrader',
      interpreter: 'none',
      ...
      env: {
        NODE_ENV: 'production',
        PAPER_STRATEGY_ID: 'pt1-oscar-regime',
        PAPER_STRATEGY_KIND: 'dip',
        PAPER_TRADES_PATH: path.join(root, 'data/paper2/pt1-oscar-regime.jsonl'),
        PAPER_HEARTBEAT_INTERVAL_MS: '30000',
        PAPER_DISCOVERY_INTERVAL_MS: '10000',
        PAPER_TRACK_INTERVAL_MS: '30000',
        PAPER_FOLLOWUP_TICK_MS: '60000',
        ...
        PAPER_PRIORITY_FEE_PERCENTILE: 'p75',
        PAPER_PRIORITY_FEE_TARGET_CU: '200000',
        PAPER_PRIORITY_FEE_CACHE_PATH: path.join(root, 'data/priority-fee-cache-pt1-oscar-regime.json'),
        PAPER_LIVE_MCAP_TTL_MS: '30000',
        ...
        /** TP-regime: классы down/up/sideways → см. `src/papertrader/pricing/tp-regime.ts`. */
        PAPER_TP_REGIME_ENABLED: '1',
        PAPER_TP_REGIME_LOOKBACK_MIN: '720',
    ...
    },
    {
      ...
      env: {
        NODE_ENV: 'production',
        PAPER_STRATEGY_ID: 'pt1-smart-lottery',
        PAPER_STRATEGY_KIND: 'smart_lottery',
        PAPER_TRADES_PATH: path.join(root, 'data/paper2/pt1-smart-lottery.jsonl'),
        PAPER_HEARTBEAT_INTERVAL_MS: '30000',
        PAPER_DISCOVERY_INTERVAL_MS: '10000',
        PAPER_TRACK_INTERVAL_MS: '30000',
        PAPER_FOLLOWUP_TICK_MS: '60000',
        PAPER_FOLLOWUP_OFFSETS_MIN: '',
        PAPER_DRY_RUN: 'false',
        PAPER_POSITION_USD: '100',
        PAPER_SAFETY_CHECK_ENABLED: '1',
        PAPER_PRIORITY_FEE_ENABLED: '0',
        ...
        SMLOT_SNAPSHOT_CANDIDATE_LIMIT: '250',
      },
    },
  ],
};
