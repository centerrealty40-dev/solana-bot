...
const HL_TWAP_LIVE_ENV = {
  ...
  HL_TWAP_LIVE_NOTIONAL_USD: '500',
  HL_TWAP_LIVE_MARGIN_MAX_USD: '500',
  HL_TWAP_LIVE_MARGIN_MIN_USD: '300',
...
const PM2_APPS = [
    ...
    /**
     * Flow8z mirror PAPER — follow 8zkgFGVZ selective entries; anti-dump exits (TP/SL/pool flush).
     * Saves infra vs own discovery; does NOT copy leader dump price.
     */
    {
      name: 'pumpswap-combo-follow-flow8z-paper',
      cwd: root,
      script: path.join(root, 'node_modules/tsx/dist/cli.mjs'),
      args: 'src/scripts/pumpswap-combo-follow-bot.ts',
      interpreter: 'node',
      ...
      env: {
        ...
        QN_FEATURE_BUDGET_DISABLED: '1',
        PUMPSWAP_COMBO_FOLLOW_EXECUTION_MODE: 'paper',
        PUMPSWAP_COMBO_FOLLOW_STRATEGY_ID: 'pumpswap-combo-follow-flow8z-paper',
        PUMPSWAP_COMBO_FOLLOW_JOURNAL_PATH: path.join(root, 'data/pumpswap-combo-follow/flow8z-paper-journal.jsonl'),
        PUMPSWAP_COMBO_FOLLOW_STATE_PATH: path.join(root, 'data/pumpswap-combo-follow/flow8z-paper-state.json'),
        PUMPSWAP_COMBO_FOLLOW_TARGET_WALLET: '8zkgFGVZrDLieViwqiXFCydSX6WL5hsxmUu55yBdsNsZ',
        PUMPSWAP_COMBO_FOLLOW_EXIT_POLICY: 'flow8z_antidump',
        PUMPSWAP_COMBO_FOLLOW_LEG_USD: '25',
        ...
        PUMPSWAP_COMBO_FOLLOW_EXIT_LADDER: '5:0.45,10:0.35,15:1',
        PUMPSWAP_COMBO_FOLLOW_EXIT_LEAD_PCT: '0',
        ...
        PUMPSWAP_COMBO_FOLLOW_FLOW_MIN_EXT_SELL_USD: '150',
        PUMPSWAP_COMBO_FOLLOW_FLOW_MAX_EXT_SELL_USD: '2500',
        PUMPSWAP_COMBO_FOLLOW_FLOW_LOOKBACK_SEC: '120',
        PUMPSWAP_COMBO_FOLLOW_BUY_DELAY_MS: '0',
        PUMPSWAP_COMBO_FOLLOW_POLL_MS: '5000',
        PUMPSWAP_COMBO_FOLLOW_POLL_FALLBACK_MS: '15000',
        PUMPSWAP_COMBO_FOLLOW_SIGNATURE_LIMIT: '25',
     ...
     */
    {
      ...
      env: {
        ...
        /** Skip micro-cap pump dust (24h backtest: skip <500k best). */
        PUMPSWAP_COMBO_FOLLOW_MIN_MCAP_USD: '500000',
