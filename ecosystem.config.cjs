     ...
     */
    {
      ...
      env: {
        ...
        LEADER_OBSERVER_LEADERS:
          '8zkgFGVZrDLieViwqiXFCydSX6WL5hsxmUu55yBdsNsZ,7BNaxx6KdUYrjACNQZ9He26NBFoFxujQMAfNLnArLGH5,FMzF9q52CpGJttEjCAixvH5rUKeW8C9Pue6651Vnrb2c',
        ...PM2_JUPITER_KEY_ENV,
        ...LIVE_OSCAR_HELIUS_RPC_ENV,
        ...(HELIUS_RPC_URL_PM2
          ? {
...
function makeMirrorApp({
  ...
  return {
    ...
    env: {
      ...
      MILD_DIP_MIRROR_LEADER_SELL_PROPORTIONAL: leaderSellProportionalEnabled,
...
if (mildDipBotApp) {
  PM2_APPS.push(
    makeMirrorApp({
      ...
      leaders: 'FMzF9q52CpGJttEjCAixvH5rUKeW8C9Pue6651Vnrb2c',
