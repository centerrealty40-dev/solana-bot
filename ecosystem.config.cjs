...
function makeMirrorApp({ name, walletSecret, walletPubkey, dataDir, leaders }) {
  return {
    ...
    env: {
      ...
      MILD_DIP_MIRROR_QUOTE_MAX_AGE_MS: '10000',
      MILD_DIP_MIRROR_MIN_LIQUIDITY_USD: '4000',
      MILD_DIP_MIRROR_MIN_PAIR_AGE_HOURS: name === 'mild-dip-mirror' ? '1' : '0.5',
      MILD_DIP_MIRROR_MIN_MCAP_USD: name === 'mild-dip-mirror' ? '50000' : '5000',
      ...
      MILD_DIP_MIRROR_AVERAGE_WINDOWS_MS:
        name === 'mild-dip-mirror'
          ? '3600000,7200000,10800000,14400000,21600000'
          : '10800000',
