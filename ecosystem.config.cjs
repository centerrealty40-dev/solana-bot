...
if (mildDipBotApp) {
  ...
  PM2_APPS.push({
    ...
    env: {
      ...
      MILD_DIP_GREEN_MAX_TAPE_RET1M_PCT: '2',
      ...
      MILD_DIP_GREEN_RUNNER_MAX_BOUNCE_FROM_TROUGH_PCT: '0',
      MILD_DIP_GREEN_RUNNER_MAX_TAPE_RET1M_PCT: '0',
      MILD_DIP_GREEN_RUNNER_MAX_TAPE_PRIOR5M_PCT: '0',
      MILD_DIP_GREEN_RUNNER_ENTRY_MAX_VOL5M_TO_LIQ: '0',
      ...
      MILD_DIP_FIRST_TOUCH_POSITION_USD: '5',
