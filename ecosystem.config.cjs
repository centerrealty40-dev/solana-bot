...
const PM2_APPS = [
    {
      ...
      env: {
        ...
        DASHBOARD_PUMPSWAP_DIP_JSONL: path.join(root, 'data/pumpswap-dip/journal.jsonl'),
     ...
     * dry_run until PUMPSWAP_DIP_WALLET_SECRET + PUMPSWAP_DIP_EXECUTION_MODE=live.
     */
    {
      name: 'pumpswap-dip-bot',
      cwd: root,
      script: path.join(root, 'node_modules/tsx/dist/cli.mjs'),
      args: 'src/scripts/pumpswap-dip-bot.ts',
      interpreter: 'node',
      exec_mode: 'fork',
      instances: 1,
      autorestart: true,
      ...
      env: {
        ...PM2_JUPITER_KEY_ENV,
        NODE_ENV: 'production',
        PUMPSWAP_DIP_STRICT_ISOLATION: '1',
        PUMPSWAP_DIP_EXECUTION_MODE: 'dry_run',
        PUMPSWAP_DIP_STRATEGY_ID: 'pumpswap-dip',
        PUMPSWAP_DIP_JOURNAL_PATH: path.join(root, 'data/pumpswap-dip/journal.jsonl'),
        PUMPSWAP_DIP_STATE_PATH: path.join(root, 'data/pumpswap-dip/state.json'),
        PUMPSWAP_DIP_WALLET_SECRET: path.join(root, 'data/pumpswap-dip/wallet.keypair.json'),
        PUMPSWAP_DIP_POLL_MS: '3000',
        PUMPSWAP_DIP_WATCHLIST_MAX: '40',
        PUMPSWAP_DIP_MIN_MCAP_USD: '20000',
        PUMPSWAP_DIP_MAX_MCAP_USD: '5000000',
        PUMPSWAP_DIP_MIN_LIQ_USD: '10000',
        PUMPSWAP_DIP_MIN_VOL_5M_USD: '500',
        PUMPSWAP_DIP_DUMP_MIN_PCT: '10',
        PUMPSWAP_DIP_DUMP_MAX_PCT: '35',
        PUMPSWAP_DIP_TP_PCT: '18',
        PUMPSWAP_DIP_SL_PCT: '25',
        PUMPSWAP_DIP_POSITION_USD: '400',
        PUMPSWAP_DIP_MAX_OPEN: '5',
        PUMPSWAP_DIP_SLIPPAGE_BPS: '600',
        SOLANA_RPC_HELIUS_PREFER: '0',
        SOLANA_RPC_HELIUS_FALLBACK_ENABLED: '1',
      },
    },
