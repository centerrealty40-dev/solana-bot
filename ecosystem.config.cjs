...
const LIVE_OSCAR_MAX_POSITION_USD = '8500';
...
const PM2_APPS = [
    ...
    },
    {
      ...
      env: {
        ...
        PAPER_DRY_RUN: 'false',
        /**
         * 1.11.552 — prod ≥$3M: 5×$1000 entry split @10s (+3/−5% corridor); avg −10% $1500, −20% $2000; max $8500 (backtest v2 proportional scale).
         */
         ...
         * было что брать как primary. Primary/defi OFF до стабилизации Shyft subscription/stream; PG — source of truth.
         */
         ...
         * Primary/defi OFF до стабилизации Shyft subscription/stream; PG — source of truth.
         */
        ...
        PAPER_RUNNER_PROBE_VOL_1H_MIN_USD: '80000',
        PAPER_RUNNER_PROBE_MIN_VOL_1H_USD: '80000',
        ...
        PAPER_PERVYY_VYSTREL_SURVEILLANCE_MIN_VOL_1H_USD: '50000',
        PAPER_PERVYY_VYSTREL_MIN_AGE_MIN: '720',
        ...
        PAPER_PERVYY_VYSTREL_RETAIL_PANIC_MAX: '0.45',
        PAPER_PERVYY_VYSTREL_MIN_UNIQUE_BUYERS_1H: '25',
        PAPER_PERVYY_VYSTREL_MAX_CLUSTER_BUYER_RATIO: '0.35',
        PAPER_PERVYY_VYSTREL_RERAMP_MIN_FROM_BOTTOM_PCT: '35',
        ...
        PAPER_PERVYY_VYSTREL_VOL_AUTH_WASH_MAX: '0.55',
        ...
        PAPER_LIVE_OSCAR_PROD_MCAP_MAX_12_PLUS_USD: '8500',
