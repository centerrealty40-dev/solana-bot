...
const PM2_APPS = [
    ...
    },
    {
      ...
      env: {
        ...
        /** Familiar bypass removed: keep explicit OFF for rollback safety. */
        PAPER_FAMILIAR_MINT_GATE_BYPASS_ENABLED: '0',
        /** Ephemeral volume spike (DADDY): dormant baseline -> sudden vol1h explosion. */
        ...
        PAPER_OLD_MINT_DORMANT_VOL_SPIKE_DORMANT_LOOKBACK_HOURS: '168',
