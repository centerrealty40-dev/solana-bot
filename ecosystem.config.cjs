...
function makeMirrorApp({
  ...
  return {
    ...
    env: {
      ...
      MILD_DIP_DATA_RETENTION_COMPRESS_AFTER_DAYS: '2',
      MILD_DIP_DATA_RETENTION_DELETE_AFTER_DAYS: '14',
      ...
      MILD_DIP_MIRROR_KNIFE_WAIT_DISCOUNT_PCT: '5',
      ...
      MILD_DIP_MIRROR_DUST_CLOSE_USD: '10',
      ...
      MILD_DIP_ORPHAN_SELL_ENABLED: '1',
      MILD_DIP_ORPHAN_SELL_MIN_USD: '0.5',
      MILD_DIP_ORPHAN_SELL_MAX_PER_PASS: '10',
      MILD_DIP_ORPHAN_SELL_INTERVAL_MS: '21600000',
      MILD_DIP_ORPHAN_SWEEP: '0',
      ...
      MILD_DIP_MIRROR_AVERAGE_MIN_DISCOUNT_PCT: '20',
