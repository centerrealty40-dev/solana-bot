...
function makeMirrorApp({
  ...
  return {
    ...
    env: {
      ...
      MILD_DIP_MIRROR_LADDER_STEP_PCT: '0',
      MILD_DIP_MIRROR_LADDER_STEP_AFTER_AVG_PCT: '0',
      MILD_DIP_MIRROR_LADDER_SELL_FRACTION: '0.25',
      ...
      MILD_DIP_MIRROR_AVERAGE_ENABLED: '0',
