 ...
 * 1.11.522 — low $2–3M: 3×$300 entry ($900), avg −10% $350 (max $1250); 10s delay + corridor unchanged.
...
const PM2_APPS = [
    ...
    },
    {
      ...
      env: {
        ...
        /** 1.11.522 — low $2M–$3M: 3×$300 @ 10s (+3/−5% corridor), avg −10% $350 (max $1250); TP2 = global DIP10_FIRST_TP5. */
