...
const PM2_APPS = [
     ...
     */
    {
      ...
      env: {
        ...
        AWAKENING_MIN_POOL_AGE_HOURS: process.env.AWAKENING_MIN_POOL_AGE_HOURS || '6',
        ...
        AWAKENING_VOL5M_SPIKE_MIN_MULT: process.env.AWAKENING_VOL5M_SPIKE_MIN_MULT || '8',
        AWAKENING_VOL5M_SPIKE_VS_1H_MIN_MULT: process.env.AWAKENING_VOL5M_SPIKE_VS_1H_MIN_MULT || '4',
        AWAKENING_QUIET_PRIOR_5M_AVG_FLOOR_USD: process.env.AWAKENING_QUIET_PRIOR_5M_AVG_FLOOR_USD || '50',
        ...
        AWAKENING_MAX_VOL5M_TO_VOL1H_RATIO: process.env.AWAKENING_MAX_VOL5M_TO_VOL1H_RATIO || '0.9',
        AWAKENING_LATE_BURST_MIN_VOL1H_USD: process.env.AWAKENING_LATE_BURST_MIN_VOL1H_USD || '15000',
        AWAKENING_MINI_PUMP_PEAK_VOL5M_TO_VOL1H_MIN:
          process.env.AWAKENING_MINI_PUMP_PEAK_VOL5M_TO_VOL1H_MIN || '0.85',
        AWAKENING_MINI_PUMP_PEAK_SPIKE_6H_MIN: process.env.AWAKENING_MINI_PUMP_PEAK_SPIKE_6H_MIN || '15',
        AWAKENING_GRADUAL_AWAKENING_ENABLED: process.env.AWAKENING_GRADUAL_AWAKENING_ENABLED || '1',
        AWAKENING_GRADUAL_VOL5M_SPIKE_6H_MULT: process.env.AWAKENING_GRADUAL_VOL5M_SPIKE_6H_MULT || '3',
        AWAKENING_GRADUAL_VOL1H_SPIKE_VS_6H_MULT: process.env.AWAKENING_GRADUAL_VOL1H_SPIKE_VS_6H_MULT || '2',
        AWAKENING_GRADUAL_MAX_PRICE_CHANGE_H6_PCT:
          process.env.AWAKENING_GRADUAL_MAX_PRICE_CHANGE_H6_PCT || '30',
        AWAKENING_GRADUAL_MAX_PRICE_CHANGE_H24_PCT:
          process.env.AWAKENING_GRADUAL_MAX_PRICE_CHANGE_H24_PCT || '60',
        AWAKENING_GRADUAL_MAX_VOL5M_SPIKE_1H_MULT:
          process.env.AWAKENING_GRADUAL_MAX_VOL5M_SPIKE_1H_MULT || '10',
        AWAKENING_GRADUAL_MAX_PRICE_CHANGE_M5_PCT:
          process.env.AWAKENING_GRADUAL_MAX_PRICE_CHANGE_M5_PCT || '15',
        AWAKENING_QUIET_PRIOR_REIGNITION_SPIKE_6H_MULT:
          process.env.AWAKENING_QUIET_PRIOR_REIGNITION_SPIKE_6H_MULT || '10',
        AWAKENING_STREAM_WARM_LOOKBACK_SEC: process.env.AWAKENING_STREAM_WARM_LOOKBACK_SEC || '3600',
        AWAKENING_STREAM_WARM_MIN_SIGS: process.env.AWAKENING_STREAM_WARM_MIN_SIGS || '1',
        AWAKENING_STREAM_WARM_MAX_PER_TICK: process.env.AWAKENING_STREAM_WARM_MAX_PER_TICK || '12',
