...
const PM2_APPS = [
    ...
    },
    {
      ...
      env: {
        ...
        /** Old-mint dormant volume spike (DADDY RCA 2026-07-05): block dead→explosion on aged mints. */
        PAPER_OLD_MINT_DORMANT_VOL_SPIKE_GUARD_ENABLED: '1',
        PAPER_OLD_MINT_DORMANT_VOL_SPIKE_MIN_TOKEN_AGE_DAYS: '100',
        PAPER_OLD_MINT_DORMANT_VOL_SPIKE_MAX_YOUNG_TOKEN_AGE_DAYS: '7',
        PAPER_OLD_MINT_DORMANT_VOL_SPIKE_LOOKBACK_HOURS: '120',
        PAPER_OLD_MINT_DORMANT_VOL_SPIKE_DORMANT_LOOKBACK_HOURS: '72',
        ...
        PAPER_OLD_MINT_DORMANT_VOL_SPIKE_MIN_BASELINE_HOURS: '24',
