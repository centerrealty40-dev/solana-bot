...
const JUPITER_PRO_TRADING_ENV = {
  ...
  JUPITER_GLOBAL_BACKGROUND_MAX_RPS: '3',
  JUPITER_BACKGROUND_MAX_WAIT_MS: '1200',
...
const PM2_APPS = [
     ...
     */
    {
      ...
      env: {
        ...
        STRATEGY_PROCESS_WATCH_TELEGRAM: '0',
     ...
     */
    {
      ...
      env: {
        ...
        MILD_DIP_EXIT_LIQ_DRAIN_MIN_AGE_MIN: '0',
        MILD_DIP_EXIT_LIQ_RATIO_MAX: '0.5',
        MILD_DIP_EXIT_LIQ_DRAIN_CONFIRM_TICKS: '2',
        MILD_DIP_EXIT_LIQ_DRAIN_SKIP_ARMED_RUNNER: '1',
        MILD_DIP_EXIT_LIQ_ABS_FLOOR_USD: '4000',
        MILD_DIP_EXIT_LIQ_DEAD_MAX_USD: '1000',
        MILD_DIP_EXIT_LIQ_DEAD_CONFIRM_MS: '30000',
        /**
...
function makeMirrorApp({
  ...
  leaderSellEnabled = true,
  leaderSellMinFraction = '0.05',
  leaderSellFullFraction = '0.9',
  buyOnly = false,
  ...
  return {
    ...
    env: {
      ...
      MILD_DIP_MIRROR_LEADER_SELL_ENABLED: leaderSellEnabled ? '1' : '0',
      ...
      MILD_DIP_MIRROR_LEADER_SELL_ONLY: buyOnly ? '0' : '1',
      ...
      MILD_DIP_MIRROR_GREEN_IMPULSE_PCT: '5',
      MILD_DIP_MIRROR_RUNUP_PC5M_PCT: '10',
      MILD_DIP_MIRROR_KNIFE_WAIT_ENABLED: knifeWaitEnabled,
      ...
      ...(manualAdoptEnabled
        ...
        : { MILD_DIP_MIRROR_MANUAL_ADOPT: '0' }),
      ...
      MILD_DIP_MIRROR_AVERAGE_ENABLED: buyOnly ? '0' : '1',
      ...
      MILD_DIP_MIRROR_CROSS_LEADER_AVERAGE_ENABLED: buyOnly ? '0' : crossLeaderAverageEnabled,
      ...
      MILD_DIP_MIRROR_COOLDOWN_MS: '900000',
      MILD_DIP_MIRROR_OWN_EXIT_ENABLED: buyOnly ? '0' : ownExitEnabled ? '1' : '0',
      ...
      MILD_DIP_MIRROR_LOSS_CAP_USD: buyOnly ? '0' : lossCapUsd,
      ...
      ...(leaderOpenBagEnabled
        ...
        : {}),
      ...(telegramOnlySubtags != null
        ? { TELEGRAM_ONLY_SUBTAGS: telegramOnlySubtags }
        : {}),
    },
  };
}
if (mildDipBotApp) {
  PM2_APPS.push(
    makeMirrorApp({
      ...
      leaders: '498SWfPJisr26J4oCiZccyzReFrByNE7jsHwbm3caNma,FMzF9q52CpGJttEjCAixvH5rUKeW8C9Pue6651Vnrb2c',
      buyOnly: true,
      leaderSellEnabled: false,
      leaderSellProportionalEnabled: '0',
      ...
      averageUsd: '50',
      averageLevelsPct: '10,20',
      averageSizeMode: 'flat',
      averageMaxUsd: '50',
      averageMaxTimes: '2',
      averageMinDiscountPct: '10',
      crossLeaderAverageEnabled: '0',
      crossLeaderAverageLeaders: '',
      ...
      tierMaxOpen: '12',
      knifeWaitEnabled: '0',
      leaderSellProportionalEnabled: '1',
      leaderSellMinFraction: '0.05',
      leaderSellFullFraction: '0.9',
    ...
    makeMirrorApp({
      ...
      sizeFromLeaderMinUsd: '5',
      sizeFromLeaderMaxUsd: '5',
      sizeFromLeaderSmallMcapUsd: '40000',
      sizeFromLeaderSmallClipUsd: '5',
      firstClipLegs: '1',
      averageUsd: '5',
...
if (mildDipBotApp) {
  ...
  PM2_APPS.push({
    ...
    env: {
      ...
      MILD_DIP_WORTHLESS_WRITEOFF_MAX_USD: '0.10',
      MILD_DIP_DUST_BURN_ENABLED: '1',
      ...
      MILD_DIP_GREEN_TAPE_BOUNDARY_MAX_AGE_MS: '150000',
      MILD_DIP_GREEN_TAPE_PRIOR_ANCHOR_MIN_AGE_MS: '240000',
      MILD_DIP_GREEN_TAPE_PRIOR_ANCHOR_MAX_AGE_MS: '600000',
      MILD_DIP_GREEN_TAPE_ANCHOR_MEDIAN_MS: '8000',
      MILD_DIP_GREEN_IMPULSE_ENABLED: '1',
      MILD_DIP_GREEN_IMPULSE_MIN_TAPE_RET1M_PCT: '8',
      MILD_DIP_GREEN_IMPULSE_MIN_TAPE_PRIOR5M_PCT: '0',
      MILD_DIP_GREEN_IMPULSE_MAX_TAPE_PRIOR5M_PCT: '80',
      MILD_DIP_PENDING_EXIT_RETRY: '1',
      MILD_DIP_GREEN_IMPULSE_MIN_TURNOVER: '0.8',
      MILD_DIP_GREEN_IMPULSE_MIN_VOL5M_USD: '15000',
      MILD_DIP_GREEN_IMPULSE_MAX_PC1H_PCT: '0',
      MILD_DIP_GREEN_MAX_RALLY_INTO_PEAK_PCT: '20',
      // капы формы входа действуют и в runner-режиме: не входим на отскоке к хаю
      MILD_DIP_GREEN_MAX_BOUNCE_FROM_TROUGH_PCT: '12',
      MILD_DIP_GREEN_MIN_PC5M_PCT: '-25',
      MILD_DIP_GREEN_MIN_PC1H_PCT: '-15',
      MILD_DIP_GREEN_MIN_RET1M_PCT: '-3',
      MILD_DIP_GREEN_MAX_TAPE_RET1M_PCT: '0.5',
      MILD_DIP_GREEN_MIN_DUMP_FROM_PEAK_PCT: '10',
      MILD_DIP_REENTRY_LEADER_ACTIVE: '1',
      // окно соответствует измеренному горизонту повторных входов лидера
      MILD_DIP_REENTRY_LEADER_ACTIVE_MS: '21600000',
      MILD_DIP_GREEN_RUNNER_RELAX: '1',
      MILD_DIP_GREEN_RUNNER_LEADER_ACTIVE_MS: '900000',
      MILD_DIP_GREEN_RUNNER_MIN_PAIR_AGE_HOURS: '0',
      ...
      MILD_DIP_GREEN_RUNNER_ENTRY_MAX_VOL5M_TO_LIQ: '3',
      ...
      MILD_DIP_GREEN_JUPITER_MINUTE_MAX_IN_FLIGHT: '3',
      MILD_DIP_GREEN_MAX_BUYS_PER_HOUR: '12',
      ...
      MILD_DIP_TICK_PHASE_TIMEOUT_MS: '60000',
      // Фиксированный $10-клип и для отключённых/резервных веток own2.
      MILD_DIP_MIRROR_POSITION_USD: '10',
      MILD_DIP_RUG_KNIFE_CLIP_USD: '10',
      MILD_DIP_STAGED_FIRST_USD: '10',
      MILD_DIP_STAGED_ADD_MAX_USD: '10',
      // фиксированный клип $10 во всех own2-лейнах.
      MILD_DIP_GREEN_POSITION_USD: '10',
      MILD_DIP_POSITION_USD: '10',
      MILD_DIP_SIZE_MIN_USD: '10',
      MILD_DIP_SIZE_LIQ_POWER_COEF: '0',
      MILD_DIP_SIZE_LIQ_POWER_EXP: '0.866',
      MILD_DIP_SIZE_MAX_USD: '10',
      MILD_DIP_FIRST_TOUCH_POSITION_USD: '10',
      MILD_DIP_THICK_POSITION_USD: '10',
      MILD_DIP_MICRO_POSITION_USD: '10',
      MILD_DIP_LSTYLE_POSITION_USD: '10',
      MILD_DIP_LSTYLE_ENABLED: '0',
      MILD_DIP_MINT_COOLDOWN_MS: '900000',
      MILD_DIP_LOSS_COOLDOWN_MS: '3600000',
      MILD_DIP_LOSS_CAP_ALL_LANES: '1',
      MILD_DIP_MIRROR_LOSS_CAP_USD: '150',
      MILD_DIP_MIRROR_LOSS_CAP_FLATTEN: '0',
