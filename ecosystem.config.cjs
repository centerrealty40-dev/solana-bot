...
const PM2_APPS = [
     ...
     */
    {
      ...
      env: {
        ...
        PUMPSWAP_COMBO_WATCHLIST_RPC_REFRESH: '0',
        PUMPSWAP_COMBO_WATCHLIST_STREAM_PREFER: '1',
        PUMPSWAP_COMBO_WATCHLIST_STREAM_FRESH_MS: '120000',
    ...
    {
      name: 'pumpswap-combo-stream',
      cwd: root,
      script: path.join(root, 'node_modules/tsx/dist/cli.mjs'),
      args: 'src/scripts/pumpswap-combo-stream.ts',
      interpreter: 'node',
      exec_mode: 'fork',
      instances: 1,
      autorestart: true,
      ...
      env: {
        NODE_ENV: 'production',
        PUMPSWAP_COMBO_STREAM_TX_GAP_MS: '350',
        PUMPSWAP_COMBO_STREAM_QUEUE_MAX: '800',
        PUMPSWAP_COMBO_STREAM_QUEUE_MAX_AGE_MS: '120000',
        PUMPSWAP_COMBO_STREAM_LOG_EVERY_N: '200',
        PUMPSWAP_COMBO_STREAM_SOURCE: 'pumpswap-combo-stream',
        QN_FEATURE_BUDGET_PUMPSWAP_COMBO_STREAM: '500000',
        QN_FEATURE_BUDGET_PUMPSWAP_COMBO: '800000',
        SOLANA_RPC_HELIUS_PREFER: '0',
        SOLANA_RPC_HELIUS_FALLBACK_ENABLED: '0',
      },
    },
