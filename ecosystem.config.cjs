...
const PM2_APPS = [
    ...
    },
    {
      ...
      env: {
        ...
        /** BTC gate (buy_open): ужесточённые пороги — было 1/2.5/2/6; сейчас 3/4/5/6 + пик 72h −6%. `0` = выкл. окна. */
        LIVE_BTC_BLOCK_1H_DRAWDOWN_PCT: '3',
        LIVE_BTC_BLOCK_4H_DRAWDOWN_PCT: '4',
        LIVE_BTC_BLOCK_24H_DRAWDOWN_PCT: '5',
     ...
     */
    {
      ...
      env: {
        ...
        /** Add + partial sell: random 5–10 s after leader action (entry buy keeps BUY_DELAY_MS). */
        COPY_TRADER_MIRROR_DELAY_MIN_MS: '5000',
        COPY_TRADER_MIRROR_DELAY_MAX_MS: '10000',
        COPY_TRADER_SELL_DELAY_MIN_MS: '5000',
        COPY_TRADER_SELL_DELAY_MAX_MS: '10000',
        COPY_TRADER_ADD_MAX_PREMIUM_PCT: '5',
        COPY_TRADER_PARTIAL_SELL_MAX_DRAWDOWN_PCT: '5',
