...
const MildDipConfigSchema = z.object({
  ...
  leaderMirror: z.object({
    ...
    minLiquidityUsd: z.coerce.number().min(0).default(8_000),
    minPairAgeHours: z.coerce.number().min(0).default(0.5),
    minMcapUsd: z.coerce.number().min(0).default(5_000),
    ...
    positionUsd: z.coerce.number().min(0).default(20),
    ...
    averageUsd: z.coerce.number().min(0).default(15),
    ...
    averageMinDiscountPct: z.coerce.number().min(0).default(2),
...
export function loadMildDipConfig(): MildDipConfig {
  ...
  const raw = {
    ...
    leaderMirror: {
      ...
      minLiquidityUsd: envNum('MILD_DIP_MIRROR_MIN_LIQUIDITY_USD', 8_000),
      minPairAgeHours: envNum('MILD_DIP_MIRROR_MIN_PAIR_AGE_HOURS', 0.5),
      minMcapUsd: envNum('MILD_DIP_MIRROR_MIN_MCAP_USD', 5_000),
      ...
      positionUsd: envNum('MILD_DIP_MIRROR_POSITION_USD', 20),
      ...
      averageUsd: envNum('MILD_DIP_MIRROR_AVERAGE_USD', 15),
      ...
      averageMinDiscountPct: envNum('MILD_DIP_MIRROR_AVERAGE_MIN_DISCOUNT_PCT', 2),
