...
const MildDipConfigSchema = z.object({
   ...
   * 1.11.839 — same $2 as base (flat book). 0 = off.
   */
...
export function loadMildDipConfig(): MildDipConfig {
  ...
  const raw = {
    ...
    /** 1.11.839 — $2 live; knife_stabilize only (see mildDipMicroSizeGatesForSource). */
