...
const MildDipConfigSchema = z.object({
   ...
   * 1.11.812 — same $10 as base (flat book). 0 = off.
   */
...
export function loadMildDipConfig(): MildDipConfig {
  ...
  const raw = {
    ...
    /** 1.11.812 — $10 live; knife_stabilize only (see mildDipMicroSizeGatesForSource). */
