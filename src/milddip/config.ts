...
const MildDipConfigSchema = z.object({
  ...
  dataRetentionCompressAfterDays: z.coerce.number().min(0).max(365).default(1),
  dataRetentionDeleteAfterDays: z.coerce.number().min(1).max(3650).default(7),
  ...
  dataRetentionEmergencyEnabled: z.boolean().default(true),
  dataRetentionEmergencyKeepDays: z.coerce.number().int().min(1).max(365).default(2),
  ...
  /** Minimum own-lane 5m volume/liquidity turnover; 0 = off. */
  entryOwnMinTurnover5mLiq: z.coerce.number().min(0).max(100_000).default(0),
  /** Maximum own-lane one-hour price change; 0 = off. */
  entryOwnMaxPc1hPct: z.coerce.number().min(0).max(100_000).default(0),
  ...
  unroutableWriteoffEnabled: z.boolean().default(false),
  unroutableWriteoffMinChecks: z.coerce.number().int().min(1).max(100).default(3),
  ...
  green: z.object({
    ...
    minPc5mPct: z.coerce.number().min(-100).max(1000).default(14),
    ...
    impulseEnabled: z.boolean().default(false),
    impulseMinTapeRet1mPct: z.coerce.number().min(-100).max(1000).default(8),
    impulseMinTapePrior5mPct: z.coerce.number().min(-100).max(1000).default(0),
    impulseMaxTapePrior5mPct: z.coerce.number().min(0).max(100000).default(0),
    impulseMinTurnover5mLiq: z.coerce.number().min(0).default(0.8),
    impulseMinVolume5mUsd: z.coerce.number().min(0).default(15_000),
    impulseMaxPc1hPct: z.coerce.number().min(0).max(1000).default(0),
    ...
    /** Runner churn cap; 0 disables the cap while runner relaxation is active. */
    runnerEntryMaxVol5mToLiq: z.coerce.number().min(0).default(0),
    ...
    tapeMinuteAnchorMedianMs: z.coerce.number().int().min(0).max(60_000).default(0),
    ...
    maxTapeRet1mPct: z.coerce.number().min(-100).max(1000).default(1000),
  ...
  leaderMirror: z.object({
    ...
    notifyAttemptDelayMs: z.coerce.number().int().min(0).default(300_000),
    ...
    manualAdoptTrailPct: z.coerce.number().min(0).default(8),
    manualAdoptIntervalMs: z.coerce.number().int().min(60_000).default(300_000),
    ...
    leaderBalanceReconcileEnabled: z.boolean().default(true),
    leaderBalanceReconcileIntervalMs: z.coerce.number().int().min(10_000).default(60_000),
    leaderBalanceReconcileConfirmations: z.coerce.number().int().min(1).max(10).default(2),
    leaderBalanceReconcileMinHoldMs: z.coerce.number().int().min(0).default(30_000),
    leaderBalanceReconcileMaxPerPass: z.coerce.number().int().min(1).max(100).default(4),
    ...
    minVol5mUsd: z.coerce.number().min(0).default(0),
    ...
    fundingParkEnabled: z.boolean().default(false),
    fundingParkRetryMs: z.coerce.number().int().min(1_000).default(30_000),
    fundingParkMax: z.coerce.number().int().min(0).default(10),
    ...
    structuralGatesEnabled: z.boolean().default(true),
    positionUsd: z.coerce.number().min(0).default(30),
    sizeLiqCoef: z.coerce.number().min(0).max(1).default(0),
    sizeLiqExp: z.coerce.number().min(0).max(2).default(0.866),
    sizeLiqMinUsd: z.coerce.number().min(0).max(10_000).default(30),
    sizeLiqMaxUsd: z.coerce.number().min(0).max(10_000).default(120),
    sizeLiqMaxPoolSharePct: z.coerce.number().min(0).max(100).default(0),
    ...
    minPc1hPct: z.coerce.number().min(-1000).max(10000).default(-1000),
    minPreEntryPc5mPct: z.coerce.number().min(-1000).max(10000).default(-1000),
    ...
    knifeWaitEnabled: z.boolean().default(true),
    knifeWaitPc5mPct: z.coerce.number().max(0).default(-10),
    knifeWaitDiscountPct: z.coerce.number().min(0).default(5),
    knifeWaitWindowMs: z.coerce.number().int().min(0).default(600_000),
    knifeWaitQuoteSlots: z.coerce.number().int().min(0).max(32).default(3),
    tierEnabled: z.boolean().default(false),
    tierIgnoreStructuralFloors: z.boolean().default(false),
    tierPositionUsd: z.coerce.number().min(0).default(10),
    tierMaxOpen: z.coerce.number().int().min(0).default(5),
    tierParkEnabled: z.boolean().default(false),
    maxPremiumPct: z.coerce.number().min(-100).default(2),
    greenMaxPremiumPct: z.coerce.number().min(-1000).default(-1000),
    entryGraceMs: z.coerce.number().int().min(0).default(60_000),
    entryGraceMaxPremiumPct: z.coerce.number().min(-100).default(1),
    ladderEnabled: z.boolean().default(true),
    ...
    ladderMaxRungs: z.coerce.number().int().min(0).default(0),
    ladderDustUsd: z.coerce.number().min(0).default(1.5),
    ladderMinSettleSec: z.coerce.number().int().min(0).default(45),
    ...
    executionStartSlippageBps: z.coerce.number().int().min(0).max(5_000).default(0),
...
export function loadMildDipConfig(): MildDipConfig {
  ...
  const green = {
    ...
    impulseEnabled: envBool('MILD_DIP_GREEN_IMPULSE_ENABLED', false),
    impulseMinTapeRet1mPct: envNum('MILD_DIP_GREEN_IMPULSE_MIN_TAPE_RET1M_PCT', 8),
    impulseMinTapePrior5mPct: envNum('MILD_DIP_GREEN_IMPULSE_MIN_TAPE_PRIOR5M_PCT', 0),
    impulseMaxTapePrior5mPct: envNum('MILD_DIP_GREEN_IMPULSE_MAX_TAPE_PRIOR5M_PCT', 0),
    impulseMinTurnover5mLiq: envNum('MILD_DIP_GREEN_IMPULSE_MIN_TURNOVER', 0.8),
    impulseMinVolume5mUsd: envNum('MILD_DIP_GREEN_IMPULSE_MIN_VOL5M_USD', 15_000),
    impulseMaxPc1hPct: envNum('MILD_DIP_GREEN_IMPULSE_MAX_PC1H_PCT', 0),
    ...
    runnerEntryMaxVol5mToLiq: envNum(
      'MILD_DIP_GREEN_RUNNER_ENTRY_MAX_VOL5M_TO_LIQ',
      0,
    ),
    ...
    tapeMinuteAnchorMedianMs: envNum('MILD_DIP_GREEN_TAPE_ANCHOR_MEDIAN_MS', 0),
    ...
    maxTapeRet1mPct: envNum('MILD_DIP_GREEN_MAX_TAPE_RET1M_PCT', 1000),
  ...
  const raw = {
    ...
    dataRetentionCompressAfterDays: envNum('MILD_DIP_DATA_RETENTION_COMPRESS_AFTER_DAYS', 1),
    dataRetentionDeleteAfterDays: envNum('MILD_DIP_DATA_RETENTION_DELETE_AFTER_DAYS', 7),
    ...
    dataRetentionEmergencyEnabled: envBool('MILD_DIP_DATA_EMERGENCY_ENABLED', true),
    dataRetentionEmergencyKeepDays: envNum('MILD_DIP_DATA_EMERGENCY_KEEP_DAYS', 2),
    ...
    entryOwnMinTurnover5mLiq: envNum('MILD_DIP_ENTRY_OWN_MIN_TURNOVER', 0),
    entryOwnMaxPc1hPct: envNum('MILD_DIP_ENTRY_OWN_MAX_PC1H_PCT', 0),
    ...
    unroutableWriteoffEnabled: envBool('MILD_DIP_UNROUTABLE_WRITEOFF_ENABLED', false),
    unroutableWriteoffMinChecks: envNum('MILD_DIP_UNROUTABLE_WRITEOFF_MIN_CHECKS', 3),
    ...
    leaderMirror: {
      ...
      buyOnlyPhantomMinAgeMs: envNum(
        'MILD_DIP_MIRROR_BUY_ONLY_PHANTOM_MIN_AGE_MS',
        300_000,
      ),
      notifyBuyEnabled: envBool('MILD_DIP_MIRROR_NOTIFY_BUY', false),
      notifyAttemptDelayMs: envNum(
        'MILD_DIP_MIRROR_NOTIFY_ATTEMPT_DELAY_MS',
        300_000,
      ),
      ...
      manualAdoptArmPct: envNum('MILD_DIP_MIRROR_MANUAL_ADOPT_ARM_PCT', 3),
      manualAdoptTrailPct: envNum('MILD_DIP_MIRROR_MANUAL_ADOPT_TRAIL_PCT', 8),
      manualAdoptIntervalMs: envNum(
        'MILD_DIP_MIRROR_MANUAL_ADOPT_INTERVAL_MS',
        300_000,
      ),
      ...
      leaderBalanceReconcileEnabled: envBool('MILD_DIP_MIRROR_LEADER_BALANCE_RECONCILE_ENABLED', true),
      leaderBalanceReconcileIntervalMs: envNum('MILD_DIP_MIRROR_LEADER_BALANCE_RECONCILE_INTERVAL_MS', 60_000),
      leaderBalanceReconcileConfirmations: envNum('MILD_DIP_MIRROR_LEADER_BALANCE_RECONCILE_CONFIRMATIONS', 2),
      leaderBalanceReconcileMinHoldMs: envNum('MILD_DIP_MIRROR_LEADER_BALANCE_RECONCILE_MIN_HOLD_MS', 30_000),
      leaderBalanceReconcileMaxPerPass: envNum('MILD_DIP_MIRROR_LEADER_BALANCE_RECONCILE_MAX_PER_PASS', 4),
      leaderOpenBagRetryEnabled: envBool('MILD_DIP_MIRROR_LEADER_OPEN_BAG_ENABLED', false),
      leaderOpenBagRetryIntervalMs: envNum('MILD_DIP_MIRROR_LEADER_OPEN_BAG_RETRY_MS', 60_000),
      leaderOpenBagMaxAgeMs: envNum('MILD_DIP_MIRROR_LEADER_OPEN_BAG_MAX_AGE_MS', 21_600_000),
      leaderOpenBagMaxEntries: envNum('MILD_DIP_MIRROR_LEADER_OPEN_BAG_MAX_ENTRIES', 60),
      ...
      lossCapResetTzOffsetMinutes: envNum(
        'MILD_DIP_MIRROR_LOSS_CAP_RESET_TZ_OFFSET_MIN',
        180,
      ),
      ...
      minVol5mUsd: envNum('MILD_DIP_MIRROR_MIN_VOL5M_USD', 0),
      ...
      fundingParkEnabled: envBool('MILD_DIP_MIRROR_FUNDING_PARK_ENABLED', false),
      fundingParkRetryMs: envNum('MILD_DIP_MIRROR_FUNDING_PARK_RETRY_MS', 30_000),
      fundingParkMax: envNum('MILD_DIP_MIRROR_FUNDING_PARK_MAX', 10),
      ...
      structuralGatesEnabled: envBool('MILD_DIP_MIRROR_STRUCTURAL_GATES_ENABLED', true),
      positionUsd: envNum('MILD_DIP_MIRROR_POSITION_USD', 30),
      sizeLiqCoef: envNum('MILD_DIP_MIRROR_SIZE_LIQ_COEF', 0),
      sizeLiqExp: envNum('MILD_DIP_MIRROR_SIZE_LIQ_EXP', 0.866),
      sizeLiqMinUsd: envNum('MILD_DIP_MIRROR_SIZE_MIN_USD', 30),
      sizeLiqMaxUsd: envNum('MILD_DIP_MIRROR_SIZE_MAX_USD', 120),
      sizeLiqMaxPoolSharePct: envNum('MILD_DIP_MIRROR_SIZE_MAX_POOL_SHARE_PCT', 0),
      ...
      minPc1hPct: envNum('MILD_DIP_MIRROR_MIN_PC1H_PCT', -1000),
      minPreEntryPc5mPct: envNum('MILD_DIP_MIRROR_MIN_PC5M_PCT', -1000),
      ...
      knifeWaitEnabled: envBool('MILD_DIP_MIRROR_KNIFE_WAIT_ENABLED', true),
      knifeWaitPc5mPct: envNum('MILD_DIP_MIRROR_KNIFE_WAIT_PC5M_PCT', -10),
      knifeWaitDiscountPct: envNum('MILD_DIP_MIRROR_KNIFE_WAIT_DISCOUNT_PCT', 5),
      knifeWaitWindowMs: envNum('MILD_DIP_MIRROR_KNIFE_WAIT_WINDOW_MS', 600_000),
      knifeWaitQuoteSlots: envNum('MILD_DIP_MIRROR_KNIFE_WAIT_QUOTE_SLOTS', 3),
      tierEnabled: envBool('MILD_DIP_MIRROR_TIER_ENABLED', false),
      tierIgnoreStructuralFloors: envBool('MILD_DIP_MIRROR_TIER_IGNORE_FLOORS', false),
      tierPositionUsd: envNum('MILD_DIP_MIRROR_TIER_POSITION_USD', 10),
      tierMaxOpen: envNum('MILD_DIP_MIRROR_TIER_MAX_OPEN', 5),
      tierParkEnabled: envBool('MILD_DIP_MIRROR_TIER_PARK_ENABLED', false),
      maxPremiumPct: envNum('MILD_DIP_MIRROR_MAX_PREMIUM_PCT', 2),
      greenMaxPremiumPct: envNum('MILD_DIP_MIRROR_GREEN_MAX_PREMIUM_PCT', -1000),
      ...
      ladderEnabled: envBool('MILD_DIP_MIRROR_LADDER_ENABLED', true),
      ...
      ladderMaxRungs: envNum('MILD_DIP_MIRROR_LADDER_MAX_RUNGS', 0),
      ladderDustUsd: envNum('MILD_DIP_MIRROR_LADDER_DUST_USD', 1.5),
      ladderMinSettleSec: envNum('MILD_DIP_MIRROR_LADDER_MIN_SETTLE_SEC', 45),
      dustCloseUsd: envNum('MILD_DIP_MIRROR_DUST_CLOSE_USD', 10),
      ...
      executionStartSlippageBps: envNum('MILD_DIP_MIRROR_EXEC_START_SLIPPAGE_BPS', 0),
