...
/** Trade strategy lane — mutex dimension (prod/scalp_wave); runner_probe is parallel via composite open key. */
export type LiveOscarTradeLane = 'prod' | 'scalp_wave' | 'runner_probe';
