/**
 * Ephemeral volume spike guard (48h dormant тЖТ recent spike).
 *
 * Blocks entries when PG hourly history shows a quiet baseline (24тАУ48h ago, or the
...
export interface OldMintDormantVolSpikeEvalOpts {
  /** Fresh Birdeye/DexScreener quote on evalRow тАФ enables live-spike block without PG baseline. */
 ...
 * (DADDY RCA тАФ coverageOk=false fail-open).
 */
...
/** Apply ephemeral dormantтЖТspike volume rules to one candidate. */
