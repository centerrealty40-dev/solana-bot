...
/** Stamp scalp_wave_v1 on open — one-shot $300, TP +10%, kill −10%, timestop 3h. */
export function stampScalpWaveExitPolicyOnOpen(ot: OpenTrade, cfg: PaperTraderConfig): boolean {
  ...
  ot.tpGridOverrides = {
    ...ot.tpGridOverrides,
    gridStepPnl: 0,
    dcaKillstop: -cfg.liveOscarScalpWaveKillPct,
  };
  return true;
}

/** Effective exit params for tracker / cfgEffectiveForOpen. */
