...
export { countOpensByMode as countMajorsOpensByMode };
...
export async function reconcileMajorsWithHl(args: {
...
/** @deprecated use reconcileMajorsWithHl */
export async function reconcileMajorsOpensForLiveMode(args: {
  ...
  if (args.client && args.universe) {
    const r = await reconcileMajorsWithHl({
      cfg: args.cfg,
      client: args.client,
      state: args.state,
