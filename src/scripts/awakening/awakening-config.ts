...
export function loadAwakeningConfig(env: NodeJS.ProcessEnv = process.env): AwakeningConfig {
  ...
  return {
    ...
    vol5mMinUsd: envNum(env.AWAKENING_VOL5M_MIN_USD, 8_000),
    minVol1hUsd: envNum(env.AWAKENING_MIN_VOL1H_USD, 20_000),
    minVol5mToVol1hRatio: envNum(env.AWAKENING_MIN_VOL5M_TO_VOL1H_RATIO, 0.08),
    maxVol24hUsd: envNum(env.AWAKENING_MAX_VOL24H_USD, 250_000),
    minPoolAgeMin: Math.round(envNum(env.AWAKENING_MIN_POOL_AGE_HOURS, 48) * 60),
    ...
    volVelocityMin: envNum(env.AWAKENING_VOL_VELOCITY_MIN, 0.1),
    minMcapUsd: envNum(env.AWAKENING_MIN_MCAP_USD, 300_000),
    minLiqUsd: envNum(env.AWAKENING_MIN_LIQ_USD, 20_000),
    minBuyRatio: envNum(env.AWAKENING_MIN_BUY_RATIO, 0.45),
    maxPriceChangeH24Pct: envNum(env.AWAKENING_MAX_PRICE_CHANGE_H24_PCT, 80),
    maxPriceChangeH6Pct: envNum(env.AWAKENING_MAX_PRICE_CHANGE_H6_PCT, 50),
    minPriceChangeM5Pct: envNum(env.AWAKENING_MIN_PRICE_CHANGE_M5_PCT, 2),
