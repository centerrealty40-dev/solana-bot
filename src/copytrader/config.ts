...
const CopyTraderConfigSchema = z.object({
  ...
  buyDelayMs: z.coerce.number().int().min(0).max(86_400_000).default(120_000),
  ...
  positionUsd: z.coerce.number().positive().max(100_000).default(300),
  addPositionUsd: z.coerce.number().positive().max(100_000).default(300),
  maxPositionUsd: z.coerce.number().positive().max(500_000).default(3000),
  maxAddsPerMint: z.coerce.number().int().min(0).max(20).default(3),
  minProportionalAddUsd: z.coerce.number().min(0).max(100_000).default(3),
  minProportionalSellFraction: z.coerce.number().min(0).max(1).default(0.005),
  buyPriceMaxPremiumPct: z.coerce.number().min(0).max(50).default(2),
  ...
  maxOpenPositions: z.coerce.number().int().min(1).max(100).default(5),
