...
const CopyTraderConfigSchema = z.object({
  ...
  positionUsd: z.coerce.number().positive().max(100_000).default(100),
  addPositionUsd: z.coerce.number().positive().max(100_000).default(30),
  maxPositionUsd: z.coerce.number().positive().max(500_000).default(190),
