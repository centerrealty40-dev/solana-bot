...
const CopyTraderConfigSchema = z.object({
  ...
  positionUsd: z.coerce.number().positive().max(100_000).default(50),
  addPositionUsd: z.coerce.number().positive().max(100_000).default(15),
  maxPositionUsd: z.coerce.number().positive().max(500_000).default(95),
