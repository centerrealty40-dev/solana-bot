...
export SPIKE_ALERT_THRESHOLD_PUMP_CONSEC_PCT="${SPIKE_ALERT_THRESHOLD_PUMP_CONSEC_PCT:-2.5}"
export SPIKE_ALERT_THRESHOLD_DUMP_CONSEC_PCT="${SPIKE_ALERT_THRESHOLD_DUMP_CONSEC_PCT:-3}"
export SPIKE_ALERT_THRESHOLD_ROLLING_PCT="${SPIKE_ALERT_THRESHOLD_ROLLING_PCT:-6}"
