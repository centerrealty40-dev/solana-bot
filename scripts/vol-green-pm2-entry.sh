...
# Fast enrich: was conc=4/probe=48/budget=40s → 25–45s lag vs leaders.
export MILD_DIP_ENRICH_CONCURRENCY="${MILD_DIP_ENRICH_CONCURRENCY:-10}"
export MILD_DIP_PROBE_ENRICH_MAX="${MILD_DIP_PROBE_ENRICH_MAX:-28}"
export MILD_DIP_MAX_ENRICH="${MILD_DIP_MAX_ENRICH:-16}"
export MILD_DIP_ENRICH_BUDGET_MS="${MILD_DIP_ENRICH_BUDGET_MS:-12000}"
export MILD_DIP_SCAN_INTERVAL_MS="${MILD_DIP_SCAN_INTERVAL_MS:-2000}"
# Force-enrich brand-new + spike re-probe (cap/min).
export MILD_DIP_FORCE_ENRICH_FIRST_SEEN_PER_MIN="${MILD_DIP_FORCE_ENRICH_FIRST_SEEN_PER_MIN:-6}"
...
export MILD_DIP_GREEN_ROCKET_MIN_BUY_SELL_5M="${MILD_DIP_GREEN_ROCKET_MIN_BUY_SELL_5M:-1.1}"
