...
export MILD_DIP_GREEN_MIN_LIQUIDITY_USD="${MILD_DIP_GREEN_MIN_LIQUIDITY_USD:-12000}"
export MILD_DIP_GREEN_MIN_MCAP_USD="${MILD_DIP_GREEN_MIN_MCAP_USD:-40000}"
...
export MILD_DIP_GREEN_EARLY_MIN_MCAP_USD="${MILD_DIP_GREEN_EARLY_MIN_MCAP_USD:-35000}"
# Rocket path — huge 5m candles (goon / 3c32HTE); max pc 0 = uncapped.
export MILD_DIP_GREEN_ROCKET_MIN_PC5M_PCT="${MILD_DIP_GREEN_ROCKET_MIN_PC5M_PCT:-25}"
...
export MILD_DIP_GREEN_ROCKET_MIN_TURNOVER_5M="${MILD_DIP_GREEN_ROCKET_MIN_TURNOVER_5M:-0.4}"
export MILD_DIP_GREEN_ROCKET_MIN_BUY_SELL_5M="${MILD_DIP_GREEN_ROCKET_MIN_BUY_SELL_5M:-1.15}"
export MILD_DIP_GREEN_ROCKET_MIN_MCAP_USD="${MILD_DIP_GREEN_ROCKET_MIN_MCAP_USD:-35000}"
