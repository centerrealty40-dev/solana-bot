...
# HARD-SET entry (4h RCA): bolder greens + buy pressure; no early; no extreme chase.
export MILD_DIP_GREEN_IMPULSE_MIN_PC5M_PCT=18
export MILD_DIP_GREEN_IMPULSE_MAX_PC5M_PCT=0
export MILD_DIP_GREEN_IMPULSE_MIN_VOLUME_5M_USD=3000
export MILD_DIP_GREEN_IMPULSE_MIN_BUY_SELL_5M=1.2
export MILD_DIP_GREEN_IMPULSE_MIN_TURNOVER_5M=0.05
export MILD_DIP_GREEN_LIQUID_MIN_PC5M_PCT=12
export MILD_DIP_GREEN_LIQUID_MIN_VOLUME_5M_USD=2500
export MILD_DIP_GREEN_LIQUID_MIN_TURNOVER_5M=0.1
export MILD_DIP_GREEN_LIQUID_MIN_BUY_SELL_5M=1.15
export MILD_DIP_GREEN_LIQUID_MAX_PC5M_PCT=25
export MILD_DIP_GREEN_LIQUID_MID_PC5M_LO=12
export MILD_DIP_GREEN_LIQUID_MID_PC5M_HI=25
export MILD_DIP_GREEN_LIQUID_MID_MIN_BUY_SELL_5M=1.4
export MILD_DIP_GREEN_LIQUID_MID_MIN_TURNOVER_5M=0.18
# Early OFF
export MILD_DIP_GREEN_EARLY_MIN_PC5M_PCT=0
export MILD_DIP_GREEN_EARLY_MIN_BUY_SELL_5M=2.5
export MILD_DIP_GREEN_ROCKET_MIN_PC5M_PCT=25
export MILD_DIP_GREEN_ROCKET_MAX_PC5M_PCT=0
export MILD_DIP_GREEN_ROCKET_MIN_VOLUME_5M_USD=15000
export MILD_DIP_GREEN_ROCKET_MIN_TURNOVER_5M=0.25
export MILD_DIP_GREEN_ROCKET_MIN_BUY_SELL_5M=1.35
export MILD_DIP_GREEN_ROCKET_MIN_MCAP_USD=18000
# pc5m>100% needs bs≥1.35 (was 1.5 — blocked E6cBb6 leader +163% at bs≈1.39)
export MILD_DIP_GREEN_EXTREME_PC5M_PCT=100
export MILD_DIP_GREEN_EXTREME_MIN_BUY_SELL_5M=1.35
# liquid_tape: liq≥25k / age≥1h / soft Dex / ring≥5% (no enrich inflate)
export MILD_DIP_GREEN_LIQUID_TAPE_MIN_LIQUIDITY_USD=25000
export MILD_DIP_GREEN_LIQUID_TAPE_MIN_PAIR_AGE_HOURS=1
export MILD_DIP_GREEN_LIQUID_TAPE_MIN_VOLUME_5M_USD=1200
export MILD_DIP_GREEN_LIQUID_TAPE_MIN_PC5M_PCT=-2
export MILD_DIP_GREEN_LIQUID_TAPE_MAX_PC5M_PCT=40
export MILD_DIP_GREEN_LIQUID_TAPE_MIN_BUY_SELL_5M=0.85
export MILD_DIP_GREEN_LIQUID_TAPE_MIN_RING_PC5M_PCT=5
