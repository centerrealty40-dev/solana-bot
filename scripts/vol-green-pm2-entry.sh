...
# Rocket path — huge 5m candles (goon / 3c32HTE); max pc 0 = uncapped.
...
export MILD_DIP_GREEN_ROCKET_MIN_VOLUME_5M_USD="${MILD_DIP_GREEN_ROCKET_MIN_VOLUME_5M_USD:-8000}"
export MILD_DIP_GREEN_ROCKET_MIN_TURNOVER_5M="${MILD_DIP_GREEN_ROCKET_MIN_TURNOVER_5M:-0}"
