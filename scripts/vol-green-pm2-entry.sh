...
export MILD_DIP_GREEN_LIQUID_MIN_PC5M_PCT="${MILD_DIP_GREEN_LIQUID_MIN_PC5M_PCT:-2}"
...
export MILD_DIP_GREEN_LIQUID_MAX_PC5M_PCT="${MILD_DIP_GREEN_LIQUID_MAX_PC5M_PCT:-15}"
export MILD_DIP_GREEN_EARLY_MIN_PC5M_PCT="${MILD_DIP_GREEN_EARLY_MIN_PC5M_PCT:-2}"
...
# Closed-set RCA: weak greens + chase>2% + hops≥3 were loss buckets.
export VOL_GREEN_MAX_CHASE_PCT="${VOL_GREEN_MAX_CHASE_PCT:-2}"
export MILD_DIP_MAX_CHASE_PCT="${MILD_DIP_MAX_CHASE_PCT:-2}"
export LIVE_BUY_MAX_CHASE_PCT="${LIVE_BUY_MAX_CHASE_PCT:-2}"
