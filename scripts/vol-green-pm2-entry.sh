...
export VOL_GREEN_POSITION_USD="${VOL_GREEN_POSITION_USD:-1}"
...
export MILD_DIP_STREAM_PRICE_CONCURRENCY=6
export MILD_DIP_STREAM_PRICE_MIN_GAP_MS=500
# Resolve: priority lane + higher headroom (overflow was blinding discovery).
export MILD_DIP_BUY_MINT_RESOLVE_MAX_PER_MIN=400
export MILD_DIP_BUY_MINT_RESOLVE_CONCURRENCY=12
export MILD_DIP_BUY_MINT_RESOLVE_QUEUE_MAX=400
...
# Dual formulas OR: F8 | F_early (~60s race) | F7 (+pc5m≥2).
export VOL_GREEN_DUAL_LEADER_FORMULAS=1
export MILD_DIP_DUAL_LEADER_FORMULAS=1
export VOL_GREEN_EARLY_TAPE=1
export VOL_GREEN_FEARLY_MAX_G_PC=8
export VOL_GREEN_FEARLY_RUNUP_PC=4
export VOL_GREEN_FEARLY_MIN_BARS=2
export VOL_GREEN_FEARLY_MIN_SAMPLES=4
export VOL_GREEN_FEARLY_MIN_SPAN_MS=60000
export VOL_GREEN_F7_MAX_G_PC=5
export VOL_GREEN_F7_RUNUP_PC=6
export VOL_GREEN_F7_RUNUP_MS=900000
export VOL_GREEN_F7_MIN_PC5M_PC=2
# Mid-impulse flex always + 20s intrabar race.
export VOL_GREEN_LEADER_FLEX=1
export VOL_GREEN_INTRABAR_FAST=1
export VOL_GREEN_INTRABAR_FAST_MIN_PC=6
# Allowlist still on for slow F8; early/mid/intrabar/F_early may race first-touch.
export VOL_GREEN_REQUIRE_LEADER_BOUGHT=1
export MILD_DIP_REQUIRE_LEADER_BOUGHT=1
export VOL_GREEN_EARLY_SKIP_REQUIRE_LEADER_BOUGHT=1
