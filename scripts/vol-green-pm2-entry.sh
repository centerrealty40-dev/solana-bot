...
export MILD_DIP_GREEN_MIN_PAIR_AGE_HOURS="${MILD_DIP_GREEN_MIN_PAIR_AGE_HOURS:-0.05}"
...
# Rocket: keep path; raise vol/bs/turnover floors (no score boost).
export MILD_DIP_GREEN_ROCKET_MIN_PC5M_PCT="${MILD_DIP_GREEN_ROCKET_MIN_PC5M_PCT:-15}"
export MILD_DIP_GREEN_ROCKET_MAX_PC5M_PCT="${MILD_DIP_GREEN_ROCKET_MAX_PC5M_PCT:-0}"
export MILD_DIP_GREEN_ROCKET_MIN_VOLUME_5M_USD="${MILD_DIP_GREEN_ROCKET_MIN_VOLUME_5M_USD:-12000}"
export MILD_DIP_GREEN_ROCKET_MIN_TURNOVER_5M="${MILD_DIP_GREEN_ROCKET_MIN_TURNOVER_5M:-0.25}"
export MILD_DIP_GREEN_ROCKET_MIN_BUY_SELL_5M="${MILD_DIP_GREEN_ROCKET_MIN_BUY_SELL_5M:-1.35}"
