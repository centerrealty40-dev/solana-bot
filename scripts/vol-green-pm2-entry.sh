...
export VOL_GREEN_DISCOVER_SOURCES=stream,gecko,profiles
export MILD_DIP_DISCOVER_SOURCES=stream,gecko,profiles
export MILD_DIP_STREAM_PRICE_SAMPLE=1
export MILD_DIP_STREAM_PRICE_CONCURRENCY=3
export MILD_DIP_STREAM_PRICE_MIN_GAP_MS=1000
export MILD_DIP_BUY_MINT_RESOLVE_MAX_PER_MIN=20
export MILD_DIP_BUY_MINT_RESOLVE_CONCURRENCY=2
export MILD_DIP_FORCE_ENRICH_FIRST_SEEN_PER_MIN=4
export VOL_GREEN_LEADER_WATCH=0
export MILD_DIP_ENRICH_CONCURRENCY=3
export MILD_DIP_PROBE_ENRICH_MAX=8
export MILD_DIP_MAX_ENRICH=6
export MILD_DIP_ENRICH_BUDGET_MS=12000
export MILD_DIP_SCAN_INTERVAL_MS=4000
