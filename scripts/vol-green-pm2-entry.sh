...
# HARD-SET simple mode: NO Helius stream / resolve / stream-price.
# Universe = gecko trending + dex profiles; entry = Gecko 1m triple_green.
export VOL_GREEN_STREAM=0
export MILD_DIP_STREAM=0
export VOL_GREEN_DISCOVER_SOURCES=gecko,profiles
export MILD_DIP_DISCOVER_SOURCES=gecko,profiles
...
# Low concurrency — Gecko OHLCV is serialized (~1.25s/call).
export MILD_DIP_ENRICH_CONCURRENCY=2
export MILD_DIP_PROBE_ENRICH_MAX=8
export MILD_DIP_MAX_ENRICH=6
export MILD_DIP_ENRICH_BUDGET_MS=20000
export MILD_DIP_SCAN_INTERVAL_MS=8000
...
export MILD_DIP_GREEN_TRIPLE_HUGE_MIN_PC=13
export MILD_DIP_GREEN_TRIPLE_HUGE_MIN_VOL_USD=150
...
# Cheap leader watch (2 wallets) — Paul/5NtNwe miss was "not in gecko trending".
export VOL_GREEN_LEADER_WATCH=1
export MILD_DIP_LEADER_RESOLVE_MAX_PER_MIN=20
...
export DEXSCREENER_GLOBAL_MAX_RPM=40
export DEXSCREENER_GATE_ENABLED=1
export DEXSCREENER_MAX_RPM=40
