...
export MILD_DIP_EXIT_CLIFF_DUMP_PNL_PCT=50
...
export MILD_DIP_EXIT_NEVER_ARM_MAX_HOLD_MS=0
...
export MILD_DIP_MAX_ENRICH=12
export MILD_DIP_ENRICH_BUDGET_MS=18000
export MILD_DIP_SCAN_INTERVAL_MS=3000
...
# First-strong 1m candle (leader-style): latest bar ≥20%, prior not already huge.
export MILD_DIP_GREEN_FIRST_STRONG_MIN_PC=20
