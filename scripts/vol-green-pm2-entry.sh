...
# Probe up to 48 by stream/ring interest → rank by vol5m → full-gate top 20.
...
# Rocket: leader-like verticals (peanut) — bs~1.15–1.2 with huge vol/turnover.
...
export MILD_DIP_GREEN_ROCKET_MIN_BUY_SELL_5M="${MILD_DIP_GREEN_ROCKET_MIN_BUY_SELL_5M:-1.15}"
