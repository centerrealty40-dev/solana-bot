...
# Never-arm = one chunk (armed trail still uses PARTIAL 50% above).
export MILD_DIP_EXIT_NEVER_ARM_PARTIAL_SELL_FRACTION=0
...
export VOL_GREEN_EXIT_NEVER_ARM_PARTIAL_SELL_FRACTION=0
