  ...
  apps: [
    {
      ...
      env: {
        ...
        DCA_WATCH_SWAP_EXEC_MIN_CYCLE_USD: process.env.DCA_WATCH_SWAP_EXEC_MIN_CYCLE_USD || '200',
        DCA_WATCH_SWAP_EXEC_MIN_TOTAL_USD: process.env.DCA_WATCH_SWAP_EXEC_MIN_TOTAL_USD || '1000',
        DCA_WATCH_SWAP_EXEC_MIN_CYCLES: process.env.DCA_WATCH_SWAP_EXEC_MIN_CYCLES || '3',
        ...
        DCA_WATCH_SWAP_EXEC_MIN_OPEN_SOL: process.env.DCA_WATCH_SWAP_EXEC_MIN_OPEN_SOL || '1',
        DCA_WATCH_DCA_OPERATORS:
          process.env.DCA_WATCH_DCA_OPERATORS || 'trfb53BmkHNeoqaa3REgqnrbwUZqAFYdjTkivkJ6aWg',
        DCA_WATCH_OPERATOR_TRACK_ENABLED: process.env.DCA_WATCH_OPERATOR_TRACK_ENABLED || '1',
        DCA_WATCH_OPERATOR_EARLY_CLOSE_MAX_RATIO: process.env.DCA_WATCH_OPERATOR_EARLY_CLOSE_MAX_RATIO || '0.25',
        DCA_WATCH_OPERATOR_EARLY_MIN_PLANNED_CYCLES: process.env.DCA_WATCH_OPERATOR_EARLY_MIN_PLANNED_CYCLES || '5',
      },
    },
  ],
};
