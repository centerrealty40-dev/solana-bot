  ...
  apps: [
    {
      ...
      env: {
        ...
        DCA_WATCH_SWAP_EXEC_MIN_CYCLE_USD: process.env.DCA_WATCH_SWAP_EXEC_MIN_CYCLE_USD || '50',
        ...
        DCA_WATCH_SWAP_EXEC_MIN_CYCLES: process.env.DCA_WATCH_SWAP_EXEC_MIN_CYCLES || '4',
        DCA_WATCH_SWAP_EXEC_MIN_TOTAL_USD: process.env.DCA_WATCH_SWAP_EXEC_MIN_TOTAL_USD || '200',
        DCA_WATCH_SWAP_EXEC_MAX_FREQ_SEC: process.env.DCA_WATCH_SWAP_EXEC_MAX_FREQ_SEC || '900',
