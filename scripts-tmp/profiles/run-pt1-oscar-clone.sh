...
export PAPER_TRADES_PATH='/opt/solana-alpha/data/paper2/pt1_oscar_clone.jsonl'
export PAPER_STRATEGY_ID='pt1_oscar_clone'
export PAPER_STRATEGY_KIND='fresh_validated'
export PAPER_FV_LABEL='oscar_clone'
export PAPER_POSITION_USD=100

# --- Вход: тот же, что у Dno / Deep Runner (pt1_dip_runners)
...
# --- Выход: оригинальный Oscar (лестница, DCA, тайм-аут) — не трогать
export PAPER_DCA_LEVELS='-12:0.5'
export PAPER_DCA_KILLSTOP=-0.25
export PAPER_DCA_REQUIRE_ALIVE=1

export PAPER_TP_LADDER='0.30:0.30,0.60:0.40,1.00:0.20'
export PAPER_TP_X=3.0
export PAPER_SL_X=0
export PAPER_TRAIL_DROP=0.20
export PAPER_TRAIL_TRIGGER_X=1.30
export PAPER_TIMEOUT_HOURS=2
