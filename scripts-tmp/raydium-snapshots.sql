...
CREATE INDEX IF NOT EXISTS raydium_pair_snapshots_ts_idx
  ON raydium_pair_snapshots (ts DESC);

CREATE INDEX IF NOT EXISTS raydium_pair_snapshots_pair_idx
  ON raydium_pair_snapshots (pair_address);

CREATE INDEX IF NOT EXISTS raydium_pair_snapshots_base_idx
  ON raydium_pair_snapshots (base_mint);
