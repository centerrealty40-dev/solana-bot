...
describe('mirror PM2 apps', () => {
  it('exports the primary mirror and keeps mirror2 disabled', () => {
    ...
    expect(ecosystemSource).toContain("MILD_DIP_MIRROR_MAX_OPEN: name === 'mild-dip-mirror' ? '0' : '8'");
    ...
    expect(ecosystemSource).toContain("MILD_DIP_MIRROR_AVERAGE_MIN_DISCOUNT_PCT: name === 'mild-dip-mirror' ? '15' : '0'");
